...
def main(argv: list[str] | None = None) -> int:
    ...
    study_command = subcommands.add_parser("study", help="Run a reproducible study")
    ...
    plan_command = subcommands.add_parser("plan-capacity", help="Run the capacity planner")
    plan_command.add_argument("--config", required=True, type=Path)
    router_command = subcommands.add_parser("replay-router", help="Run offline router replay")
    router_command.add_argument("--config", required=True, type=Path)
    hardening_command = subcommands.add_parser("hardening-check", help="Run repository audit checks")
    ...
    dashboard_command = subcommands.add_parser("dashboard", help="Run the local browser dashboard")
